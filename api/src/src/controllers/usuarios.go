...
func BuscarSeguindo(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	usuarioSeguindo, erro := repositorio.UsuarioSeguindo(usuarioID)

	respostas.JSON(w, http.StatusOK, usuarioSeguindo)
}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("você não pode alterar a senha de um usuario que não seja o seu"))
	}
